...
public class MarihuanaItem extends Item {
    ...
    public MarihuanaItem(Properties group) {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving) {
        if (!worldIn.isRemote && entityLiving instanceof PlayerEntity) {
            ...
            playerEntity.addPotionEffect(new EffectInstance(ModEffects.MARIHUANA_EFFECT.get(), 200, 1));
            playerEntity.addPotionEffect(new EffectInstance(Effects.REGENERATION, 2400, 0));  // Regeneración I durante 2 minutos
        ...
        playerEffects.entrySet().removeIf(entry -> {
            ...
            if (ticksLeft <= 0) {
                ...
                if (world instanceof ServerWorld) {
                    ...
                    if (player != null) {
                        player.addPotionEffect(new EffectInstance(Effects.HUNGER, 7200, 0, false, false, true));  // Fatiga de minería I durante 2 minutos, sin partículas, sin icono, pero se muestra en el inventario
                        player.addPotionEffect(new EffectInstance(Effects.SLOWNESS, 7200, 0, false, false, true));  // Lentitud I durante 2 minutos, sin partículas, sin icono, pero se muestra en el inventario
                    }
                }
