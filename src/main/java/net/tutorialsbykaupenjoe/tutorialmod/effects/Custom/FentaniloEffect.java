...
public class FentaniloEffect extends Effect {
    protected FentaniloEffect(EffectType typeIn, int liquidColorIn) {
    ...
    public void performEffect(LivingEntity entityLivingBaseIn, int amplifier) {
        Minecraft.getInstance().enqueue(() -> {
            if (entityLivingBaseIn.isPotionActive(this)) {
                ...
                ResourceLocation shader = new ResourceLocation("tutorialmod", "shaders/post/fentanilo.json");
